    ...
    <div class="row">
        <div class="col-md-12 progress-tracker-container">
            ...
            <div class="alert alert-success confident-message text-center nearly-done">
                <nav>
                    <ul class="pager">
                        <li class="previous hidden"><a href="CreateProject_03_09?id=<%=param_projid%>"><span aria-hidden="true">&larr;</span></a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body_left" runat="server">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-xs-6">
                <a href="CreateProject_03_09?id=<%=param_projid%>" class="btn btn-greenline">Back to Previous Step</a>
            </div>

...
namespace BestBoQ
{
    public partial class GenerateContract : System.Web.UI.Page
    {
        ...
        private Paragraph GetBody()
        {
            ...
            para.Add(new Phrase("ขออนุมัติให้นักศึกษาจำนวน " + "10" + " คน เดินทางไปราชการต่างประเทศระหว่างวันที่ " + "1" + " ถึงวันที่ " + "2" + " รวม " + "2" + " วัน เพื่อดำเนินกิจกรรมดังต่อไปนี้", normal));

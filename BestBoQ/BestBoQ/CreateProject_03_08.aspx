...
<asp:Content ID="Content2" ContentPlaceHolderID="progress" runat="server">
            ...
            <div class="alert alert-success confident-message text-center nearly-done">
                <nav>
                    <ul class="pager">
                        ...
                        <li class="active"><a href="CreateProject_03_08?id=<%=param_projid%>">7. ระบบงานสุขาภิบาล (Sanitation)</a></li>
                        ...
                        <li class="next"><a href="CreateProject_03_09?id=<%=param_projid%>"><span aria-hidden="true">&rarr;</span></a></li>
                    </ul>
                </nav>
            </div>
    ...
    <h3>Choose project materials <small>ระบบงานสุขาภิบาล (Sanitation)</small></h3>
</asp:Content>

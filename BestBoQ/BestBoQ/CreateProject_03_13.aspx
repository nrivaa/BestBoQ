<%@ Page Title="" Language="C#" MasterPageFile="~/CreateHomeNestedMaster.master" AutoEventWireup="true" CodeBehind="CreateProject_03_13.aspx.cs" Inherits="BestBoQ.CreateProject_03_13" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="progress" runat="server">
    <div class="row">
        <div class="col-md-12 progress-tracker-container">
           ...
           <div class="alert alert-success confident-message text-center nearly-done">
                <nav>
                    <ul class="pager">
                        <li class="previous"><a href="CreateProject_03_12?id=<%=param_projid%>"><span aria-hidden="true">&larr;</span></a></li>
                        ...
                        <li class="active"><a href="CreateProject_03_13?id=<%=param_projid%>">12. ราวระเบียง และราวบันได Railing</a></li>
                        <li><a href="CreateProject_03_14?id=<%=param_projid%>">13</a></li>
                        <li><a href="CreateProject_03_15?id=<%=param_projid%>">14</a></li>
                        <li class="next"><a href="CreateProject_03_14?id=<%=param_projid%>"><span aria-hidden="true">&rarr;</span></a></li>
                    </ul>
                </nav>
            </div>
    ...
    <h3>Choose project materials <small>ราวระเบียง และราวบันได Railing</small></h3>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="body_left" runat="server">
    <div class="panel-body">
                                        ...
                                        <div class="thumbnail">
                                            ...
                                            <div class="caption text-center">
                                                <h3>
                                                    ...
                                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("railingType")%>'></asp:Label>
                                                </h3>
        ...
        <div class="row">
            <div class="col-xs-6">
                <a href="CreateProject_03_12?id=<%=param_projid%>" class="btn btn-default">Back to Previous Step</a>
            </div>

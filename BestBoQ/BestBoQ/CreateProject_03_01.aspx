<%@ Page Title="" Language="C#" MasterPageFile="~/CreateHomeNestedMaster.master" AutoEventWireup="true" CodeBehind="CreateProject_03_01.aspx.cs" Inherits="BestBoQ.CreateProject_03_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="progress" runat="server">
    <div class="row">
        <div class="col-md-12 progress-tracker-container">
            ...
            <div class="alert alert-success confident-message text-center nearly-done" data-bind="html: progressTracker.nearlyDoneText">
                <nav>
                    <ul class="pager">
                        <li class="previous hidden"><a href="CreateProject_02?id=<%=param_projid%>"><span aria-hidden="true">&larr;</span></a></li>
    ...
    <h3>Choose project materials <small>ระบบงานฐานราก (Footing)</small></h3>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="body_left" runat="server">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-xs-6">
                <a href="CreateProject_02?id=<%=param_projid%>" class="btn btn-greenline">Back to Previous Step</a>
            </div>

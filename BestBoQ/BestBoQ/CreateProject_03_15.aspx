                    ...
                    <div class="form" role="form">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <p class="text-right">
                                    ยังเหลือค่าอีกร้อยละ
                                    <asp:Label ID="tbRemainPCT" ForeColor="Red" runat="server" Text='100'></asp:Label>
                                    ที่ยังไม่ได้ใส่ในตาราง
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <h4>รายละเอียด หรือรายการเอกสารแนบท้ายสัญญา (โปรดระบุ ถ้ามี)</h4>
                                <br />
                                <asp:TextBox ID="tbComment01" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>      
                                <br />
                                <asp:TextBox ID="tbComment02" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment03" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment04" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment05" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment06" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment07" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment08" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment09" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                                <br />
                                <asp:TextBox ID="tbComment10" CssClass="form-control" runat="server" Rows="1" MaxLength="250"></asp:TextBox>
                            </div>
                        </div>
                        <br />
                    </div>

                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="pm-staff-profile-container">
                        ...
                        <div class="pm-staff-profile-details text-center">
                            ...
                            <p class="pm-staff-profile-bio">สัญญาว่าจ้างก่อสร้าง โดยมีการทำข้อตกลงกันก่อนร่างสัญญาระหว่างผู้ว่าจ้าง (เจ้าของบ้าน) กับผู้รับจ้าง (ผู้รับเหมา) นอกจากนี้จะมีพยานเซ็นรับรองเอกสารท้ายฉบับ โดยเอกสารนี้ ผู้รับจ้างและผู้ว่าจ้างจะเก็บไว้ฝ่ายละชุดเนื้อหาในเอกสารสัญญาว่าจ้างประกอบด้วยหัวข้อหลักๆ ดังต่อไปนี้ รายละเอียดระหว่างผู้ว่างจ้าง และผู้รับจ้าง , ขอบเขตงาน ,ระยะเวลาการก่อสร้าง ,ข้อตกลงอื่นๆ เกี่ยวกับรายละเอียดแบบ การเปลี่ยนแปลงหรือยกเลิกสัญญาว่าจ้าง การผิดสัญญาการทำงาน  และระยะกำหนดการทำงาน</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="pm-staff-profile-container">
                        ...
                        <div class="pm-staff-profile-details text-center">
                            ...
                            <p class="pm-staff-profile-bio">“การแบ่งงวดงาน” คือการชำระเงินตามปริมาณที่ทำไปแล้วเสร็จในเเต่ละขั้นตอน  การเเบ่งงวดงานจำเป็นต้องมีความรู้เเละอาศัยประสบการณ์ในเรื่องการก่อสร้าง เพราะเมื่อเราแบ่งงวดงานตามขั้นตอนแล้ว ก็ต้องคำนวณค่าจ้างที่ต้องจ่ายในเเต่ละงาน ดังนั้นสำหรับผู้ที่ไม่มีประสบการณ์ด้านนี้เลย  Best BOQมีฟังชั่นสำหรับแบ่งงวดงานให้มีความยุติธรรมระหว่างผู้รับจ้างและผู้ว่าจ้าง </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="pm-staff-profile-container">
                        ...
                        <div class="pm-staff-profile-details text-center">
                            ...
                            <p class="pm-staff-profile-bio">การวางแผนงานก่อสร้าง เป็นขั้นตอนที่สำคัญ ในการบริหารงานก่อสร้าง ให้มีประสิทธิภาพ หากไม่มีการวางแผนงานก่อสร้างไว้ หรือวางแผนไว้ไม่ถูกต้อง การควบคุมโครงการ จะทำได้ลำบาก เนื่องจาก ไม่มีข้อมูลที่จะใช้ตรวจสอบ ความก้าวหน้าของโครงการ ทำให้ไม่สามารถแก้ไขปัญหาหรืออุปสรรค ต่าง ๆ ได้ ดังนั้น Best BOQ จึงได้ทำการวางแผนงานก่อสร้างเบื้องต้นให้เพื่อใช้เป็นขอตกลงในการทำงานร่วมกันระหว่างผู้ว่าจ้างและผู้รับจ้างที่โครงการเสร็จตามเวลาที่กำหนด </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="pm-staff-profile-container">
                        ...
                        <div class="pm-staff-profile-details text-center">
                            ...
                            <p class="pm-staff-profile-bio">คือฟังชั่นรวมเอกสารทั้งหมดให้อยู่ในไฟล์เดียวกันคือ สัญญา,BOQ,งวดงาน ,แผนงาน และเอกสารวิเคราะห์ต้นทุนกำไร เพื่ออำนวยความสะดวกต่อผู้ใช้งาน BestBOQ ให้มีความรวดเร็วในการทำงานมากยิ่งขึ้น </p>
                        </div>
                    </div>
                </div>
            </div>
